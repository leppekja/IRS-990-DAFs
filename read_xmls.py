...
def xml_to_dict(tree):
    ...
    repeated keys, as the IRS form repeats keys
    for many categories. Looking for better way
    to implement this. 
    Input: ElementTree Object
...
def aggregate(folder_path, *args):
    '''
    Iterate through folder of 990s, applies
